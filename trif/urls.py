...
urlpatterns = patterns('',
    ...
    url(r'^alerts.(?P<file_type>xml|jsonp?)$', 'trif_feeds.views.alerts_feed',
        name='alerts_feed'),
    ...
    url(r'^alerts/incidents.(?P<file_type>xml|jsonp?)$',
    ...
    url(r'^alerts/closures.(?P<file_type>xml|jsonp?)$',
