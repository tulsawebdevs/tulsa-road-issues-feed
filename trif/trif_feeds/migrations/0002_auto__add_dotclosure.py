...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DotClosure'
        db.create_table('trif_feeds_dotclosure', (
        ...
        db.send_create_signal('trif_feeds', ['DotClosure'])


    def backwards(self, orm):
        
        # Deleting model 'DotClosure'
        db.delete_table('trif_feeds_dotclosure')


    models = {
        'trif_feeds.dotclosure': {
            'Meta': {'object_name': 'DotClosure'},
